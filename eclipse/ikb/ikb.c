...
int8_t ikey_is_all_process_finished(void);
    ...
    static inline uint8_t keyRead_pin_key7(void)
	{
		return ReadPin(PORTRxKB_KEY7, PINxKB_KEY7);
	}
    static inline uint8_t keyRead_pin_key8(void)
	{
		return ReadPin(PORTRxKB_KEY8, PINxKB_KEY8);
	}
...
//        PinTo1(PORTWxKB_KEY8, PINxKB_KEY8);
		...
		ConfigInputPin(CONFIGIOxKB_KEY7, PINxKB_KEY7);
		ConfigInputPin(CONFIGIOxKB_KEY8, PINxKB_KEY8);
		...
		key[7].keyRead = keyRead_pin_key7;
		key[8].keyRead = keyRead_pin_key8;
